...
public:
    NodeA() : Node("node_a"), last_message_time_(this->now()), last_data_(2), count(0) {
        ...
        std::chrono::milliseconds(500), std::bind(&NodeA::PublishMessage, this));
...
private:
    ...
    void messageCallback(const std_msgs::msg::Int32::SharedPtr msg) {
        ...
        RCLCPP_INFO(this->get_logger(), "repeatedly received %d .member_a may be crash!", msg->data");
        }else{
